...
import 'package:oceantodo/Approute/approute.dart';
import 'package:oceantodo/Blocs/bloc/stickers_bloc.dart';
import 'package:oceantodo/Locator/servlocator.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
      providers: [
        RepositoryProvider(
          create: (context) => StickerRepoImpl(),
        )
      ],
      child: MultiBlocProvider(
        providers: [
          ...
          BlocProvider(
              create: (context) => StickersBloc(
                  stickerRepoImpl: context.read<StickerRepoImpl>())),
          BlocProvider(
